...
def lst_with_aug_reg_400_700_wave_index_loop(src_dir):
    ...
    # Input CWL: 450~660nm, evenly divided into 10 points, rounded to integer
    input_cwl_list = [round(x) for x in np.linspace(450, 660, 10)]
    ...
    print(f"Input CWL list (450~660nm, 10 points): {input_cwl_list}")
...
if __name__ == "__main__":
    ...
    file_path = r'F:\05-Jerome Studios\Coating Design\Coating_data\UC450-DE'
    ...
    name = r"202604151712-U450_MEMS_CN_Ti3O5_MF_J09"
    new_uc450 = os.path.join(file_path, name)
    lst_with_aug_reg_400_700_wave_index_loop(new_uc450)
